...
from emedia.processing.ali_cumul.ylmf_adzone_cumul import (
    tmall_ylmf_daliy_adzone_cumul_etl_new,
)
from emedia.processing.ali_cumul.ylmf_campaign_cumul import (
    tmall_ylmf_campaign_cumul_etl_new,
)
from emedia.processing.ali_cumul.ylmf_campaign_group_cumul import (
    tmall_ylmf_campaign_group_cumul_etl_new,
)
from emedia.processing.ali_cumul.ylmf_creativepackage_cumul import (
    tmall_ylmf_daliy_creativepackage_cumul_etl_new,
)
from emedia.processing.ali_cumul.ylmf_crowd_cumul import (
    tmall_ylmf_daliy_crowd_cumul_etl_new,
)
from emedia.processing.ali_cumul.ylmf_cumul_daily import ylmf_cumul_daily_fact
from emedia.processing.ali_cumul.ylmf_promotion_cumul import (
    tmall_ylmf_daliy_promotion_cumul_etl_mew,
)
from emedia.processing.ali_cumul.ztc_adgroup_cumul import (
    tmall_ztc_cumul_adgroup_etl_new,
)
from emedia.processing.ali_cumul.ztc_campaign_cumul import (
    tmall_ztc_cumul_campaign_etl_new,
)
from emedia.processing.ali_cumul.ztc_creative_cumul import (
    tmall_ztc_cumul_creative_etl_new,
)
from emedia.processing.ali_cumul.ztc_cumul_daily import ztc_cumul_daily_fact
from emedia.processing.ali_cumul.ztc_keyword_cumul import (
    tmall_ztc_cumul_keyword_etl_new,
)
...
from emedia.processing.jd_new.jd_zw_campaign_daily import jd_zw_campaign_etl
from emedia.processing.jd_new.jd_zw_creative_daily import jd_zw_creative_etl
...
from emedia.processing.jd_new.tb_media_emedia_jd_seckill_daily_fact import (
