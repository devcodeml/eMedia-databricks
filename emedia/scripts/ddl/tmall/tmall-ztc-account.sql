%sql
-- tmall_ztc_account
DROP TABLE IF EXISTS `dws`.`tb_emedia_tmall_ztc_account_mapping_success`;
CREATE TABLE IF NOT EXISTS `dws`.`tb_emedia_tmall_ztc_account_mapping_success` (
     cart_total String,
...
LOCATION  'dbfs:/mnt/prod/data_warehouse/media_dws.db/tb_emedia_tmall_ztc_account_mapping_success';


DROP TABLE IF EXISTS `stg`.`tb_emedia_tmall_ztc_account_mapping_fail`;
CREATE TABLE IF NOT EXISTS `stg`.`tb_emedia_tmall_ztc_account_mapping_fail` (
    cart_total String,
     cart_total_coverage String,
     click String,
     click_shopping_amt String,
...
USING delta
PARTITIONED BY (`thedate`)
LOCATION  'dbfs:/mnt/prod/data_warehouse/media_stg.db/tb_emedia_tmall_ztc_account_mapping_fail';
