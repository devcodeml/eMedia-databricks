%sql
-- tmall_ztc_keyword
DROP TABLE IF EXISTS `dws`.`tb_emedia_tmall_ztc_keyword_mapping_success`;
CREATE TABLE IF NOT EXISTS `dws`.`tb_emedia_tmall_ztc_keyword_mapping_success` (
    thedate String,
    impression String,
    click String,
    cost String,
...
LOCATION  'dbfs:/mnt/qa/data_warehouse/media_dws.db/tb_emedia_tmall_ztc_keyword_mapping_success';


DROP TABLE IF EXISTS `stg`.`tb_emedia_tmall_ztc_keyword_mapping_fail`;
CREATE TABLE IF NOT EXISTS `stg`.`tb_emedia_tmall_ztc_keyword_mapping_fail` (
    thedate String,
    impression String,
    click String,
    cost String,
...
USING delta
PARTITIONED BY (`thedate`)
LOCATION  'dbfs:/mnt/qa/data_warehouse/media_stg.db/tb_emedia_tmall_ztc_keyword_mapping_fail';
