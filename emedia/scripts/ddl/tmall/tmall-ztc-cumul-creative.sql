%sql
-- tmall_ztc_cumul_creative
DROP TABLE IF EXISTS `dws`.`tb_emedia_tmall_ztc_cumul_creative_mapping_success`;
CREATE TABLE IF NOT EXISTS `dws`.`tb_emedia_tmall_ztc_cumul_creative_mapping_success` (
    adgroup_id String,
...
LOCATION  'dbfs:/mnt/qa/data_warehouse/media_dws.db/tb_emedia_tmall_ztc_cumul_creative_mapping_success';


DROP TABLE IF EXISTS `stg`.`tb_emedia_tmall_ztc_cumul_creative_mapping_fail`;
CREATE TABLE IF NOT EXISTS `stg`.`tb_emedia_tmall_ztc_cumul_creative_mapping_fail` (
    adgroup_id String,
    adgroup_title String,
    campaign_id String,
    campaign_title String,
...
USING delta
PARTITIONED BY (`thedate`)
LOCATION  'dbfs:/mnt/qa/data_warehouse/media_stg.db/tb_emedia_tmall_ztc_cumul_creative_mapping_fail';
