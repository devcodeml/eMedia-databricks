CREATE TABLE `dws`.`media_emedia_aliylmf_day_promotion_report_cumul_mapping_success` (
  `ad_date` STRING,
...
USING delta
LOCATION  'dbfs:/mnt/qa/data_warehouse/media_dws.db/media_emedia_aliylmf_day_promotion_report_cumul_mapping_success';


CREATE TABLE `stg`.`media_emedia_aliylmf_day_promotion_report_cumul_mapping_fail` (
  `ad_date` STRING,
  `campaign_group_id` INT,
  `campaign_group_name` STRING,
  `campaign_id` BIGINT,
  ...
  `etl_create_time` TIMESTAMP)
USING delta
LOCATION 'dbfs:/mnt/qa/data_warehouse/media_stg.db/media_emedia_aliylmf_day_promotion_report_cumul_mapping_fail';