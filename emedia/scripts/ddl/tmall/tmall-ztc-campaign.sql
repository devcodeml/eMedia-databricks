%sql
-- tmall_ztc_campaign
DROP TABLE IF EXISTS `dws`.`tb_emedia_tmall_ztc_campaign_mapping_success`;
CREATE TABLE IF NOT EXISTS `dws`.`tb_emedia_tmall_ztc_campaign_mapping_success` (
    campaign_id String,
...
LOCATION  'dbfs:/mnt/qa/data_warehouse/media_dws.db/tb_emedia_tmall_ztc_campaign_mapping_success';


DROP TABLE IF EXISTS `stg`.`tb_emedia_tmall_ztc_campaign_mapping_fail`;
CREATE TABLE IF NOT EXISTS `stg`.`tb_emedia_tmall_ztc_campaign_mapping_fail` (
    campaign_id String,
    campaign_title String,
    campaign_type String,
    campaign_type_name String,
...
USING delta
PARTITIONED BY (`thedate`)
LOCATION  'dbfs:/mnt/qa/data_warehouse/media_stg.db/tb_emedia_tmall_ztc_campaign_mapping_fail';
