...
def jd_jst_campaign_etl(airflow_execution_date):
    '''
    ...
    output_to_emedia(tb_emedia_jd_jst_campaign_df, f'{date}/{date_time}/jst', 'EMEDIA_JD_JST_DAILY_CAMPAIGN_REPORT_FACT.CSV')
