...
def jd_sem_campaign_etl(airflow_execution_date:str = ''):
    ...
    db_df = spark.sql("""
        select  ad_date as ad_date,
                ...
                req_isdaily as req_isdaily,
                effect_days as effect_days,
                req_isorder_orclick as req_isorder_orclick,
                gift_flag as gift_flag,
                order_statuscategory as order_statuscategory,
                mobile_type as mobile_type,
                impressions as impressions,
                clicks as clicks,
                ctr as ctr,
                cost as cost,
                ...
                direct_order_quantity as direct_order_quantity,
                direct_order_value as direct_order_value,
                effect_order_quantity as effect_order_quantity,
                effect_order_value as effect_order_value,
                indirect_order_quantity as indirect_order_quantity,
                indirect_order_value as indirect_order_value,
                order_quantity as order_quantity,
                order_value as order_value,
