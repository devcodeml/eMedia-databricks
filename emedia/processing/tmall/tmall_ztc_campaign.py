...
def tmall_ztc_campaign_etl(airflow_execution_date,run_id):
    ...
    spark.sql("""
        ...
        AND dws.tb_emedia_tmall_ztc_campaign_mapping_success.req_pv_type_in = all_mapping_success.req_pv_type_in
    ...
    spark.sql("optimize dws.tb_emedia_tmall_ztc_campaign_mapping_success")
