...
def tmall_ylmf_daliy_promotion_etl(airflow_execution_date, run_id):
    ...
    if table_exist == 0:
        res[0].write.mode("overwrite").saveAsTable("dws.media_emedia_aliylmf_day_promotion_report_mapping_success")
    else:
        spark.sql("""
              ...
              WHEN NOT MATCHED
                  THEN INSERT *
            """)
    res[1].write.mode("overwrite").saveAsTable("stg.media_emedia_aliylmf_day_promotion_report_mapping_fail")
    # 全量输出
