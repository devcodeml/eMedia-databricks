...
def tmall_mxdp_campaign_etl(airflow_execution_date:str = ''):
    '''
    ...
    tb_emedia_tmall_mxdp_campaign_df = spark.sql(f'''
        ...
        FROM (
            SELECT *
            FROM dws.tb_emedia_tmall_mxdp_campaign_mapping_success WHERE thedate >= '{days_ago912}' AND thedate <= '{curr_date}'
                UNION
            SELECT *
