...
def tmall_ylmf_campaign_group_etl(airflow_execution_date, run_id):
    ...
    input_path = f'fetchResultFiles/{file_date.strftime("%Y-%m-%d")}/tmall/ylmf_daily_displayreport/tmall_ylmf_day_campaignGroup_{file_date.strftime("%Y-%m-%d")}.csv.gz'
    ...
    report_df = read_json_content_df.na.fill("").selectExpr("log_data as ad_date", "campaign_group_id",
                                                            ...
                                                            "add_new_uv_cost", "add_new_uv_rate",
                                                            "alipay_inshop_amt",
                                                            "alipay_inshop_num", "cart_num", "charge", "click",
                                                            "deep_inshop_pv", "dir_shop_col_num", "gmv_inshop_amt",
                                                            "gmv_inshop_num", "impression", "inshop_item_col_num",
                                                            "inshop_potential_uv", "inshop_pv", "inshop_uv",
                                                            "prepay_inshop_amt", "prepay_inshop_num", "return_pv",
                                                            "search_click_cnt", "dw_resource", "dw_create_time",
                                                            "dw_batch_number")
