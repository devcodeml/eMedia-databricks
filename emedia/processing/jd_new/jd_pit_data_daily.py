...
def jd_pit_data_daily_etl(airflow_execution_date, run_id):
    """
    ...
    jd_pit_data_daily_path = f'tier_package/yd_jd_api_epos_pit_data/yd_jd_api_epos_pit_data_{file_date.strftime("%Y%m%d")}.csv'
