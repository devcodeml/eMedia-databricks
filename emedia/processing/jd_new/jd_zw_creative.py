...
def jd_zw_creative_etl(airflow_execution_date, run_id):
    ...
    (
        ...
        spark, jdzw_creative_df.union(jdzw_creative_fail_df), "dmp"
    )
    jdzw_creative_daily_mapping_success.dropDuplicates(
        jdzw_creative_pks
    ...
    jdzw_creative_daily_mapping_fail.dropDuplicates(jdzw_creative_pks).write.mode(
        "overwrite"
    ).option("mergeSchema", "true").insertInto("dwd.jdzw_creative_daily_mapping_fail")
