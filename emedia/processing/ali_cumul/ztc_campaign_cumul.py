...
def tmall_ztc_cumul_campaign_etl(airflow_execution_date, run_id):
    ...
    tmall_ztc_cumul_campaign_daily_df.union(tmall_ztc_cumul_campaign_fail_df).createOrReplaceTempView(
        "tmall_ztc_cumul_campaign_daily")
    ...
    tbtb_emedia_tmall_ztc_cumul_campaign_golden = tb_emedia_tmall_ztc_cumul_campaign_df.union(
        tb_emedia_tmall_ztc_cumul_campaign_current_fail_df)
    ...
    output_to_emedia(tbtb_emedia_tmall_ztc_cumul_campaign_golden, f'{date}/{date_time}/ztc',
                     'EMEDIA_TMALL_ZTC_DAILY_CAMPAIGN_REPORT_NEW_FACT_CUMUL.CSV', dict_key='cumul')

    output_to_emedia(eab_db, f'fetchResultFiles/ALI_days/ZTC_CUMUL/{run_id}', f'tmall_ztc_day_campaign_{date}.csv.gz',
