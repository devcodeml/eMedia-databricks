...
def tmall_ylmf_daliy_creativepackage_cumul_etl_new(airflow_execution_date):
    ...
    tmall_ylmf_creative_package_daily_df = extend_json_content_df.na.fill("").selectExpr("log_data as ad_date", "campaign_group_id",
                                                            "campaign_group_name",
    ...
    (
        ylmf_creative_package_daily_res.distinct()
