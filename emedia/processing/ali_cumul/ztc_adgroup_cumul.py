...
def tmall_ztc_cumul_adgroup_etl(airflow_execution_date, run_id):
    ...
    first_row_data = tmall_ztc_cumul_adgroup_daily_df.first().asDict()
    ...
    tb_emedia_tmall_ztc_cumul_adgroup_golden_df = tb_emedia_tmall_ztc_cumul_adgroup_df.union(
        tb_emedia_tmall_ztc_cumul_adgorup_current_fail_df)
    ...
    eab_db = spark.sql(f"""
            select  direct_cart_total as directcarttotal,
                    ...
                    req_page_size as req_page_size,
                    req_effect as req_effect
            from    tb_emedia_tmall_ztc_cumul_adgroup
        """)
